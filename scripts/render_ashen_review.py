...
print(front_target)
side_target = target.with_name("ashen_knight_side_review.png")
lit_render(data, elements, atlas, animations["idle"], 0, "side", 22).save(side_target)
print(side_target)

back = lit_render(data, elements, atlas, animations["idle"], 0, "back", 22)
