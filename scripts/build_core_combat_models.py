...
def build_warrior_support(assets,write_json):
    from build_warrior_support_art import build
    build(assets,write_json)
...
def build_slash_frames(assets, write_json):
    ...
    from build_approved_aa_v3 import build as build_approved_aa_v3
    ...
    from build_mage_materials import build as build_mage_materials
    build_mage_materials(assets, write_json)
