# Frozen from c34c624 for user-approved GIF SHA256 497a6e17ec93f83f8aca8851d6d0e6919fea1c0be6ea1ca21177643a6de31828.
# Change the runtime integration, not this approved contour, without creator approval.
...
def build(assets, write):
    ...
    for layer, count in (('blade', 10), ('wake', 16), ('impact', 9)):
        for frame in range(count):
            ...
            name = f'combat_vfx/approved_dash_v3/{layer}_{frame}'
