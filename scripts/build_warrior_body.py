...
Each exposed torso and arm face is authored separately. Broad blue-steel
planes, dark leather gaps, and brass trim define the forge-warrior set.
"""
...
ITEM_FRONT = (
    '..1221..','.1222221','12344321','12332221',
    '12233221','11223211','11222211','11111111',
    '15666651','16677661','12222221','12344321',
)
ITEM_BACK = TORSO_BACK[:8]+('15666651','16677661','12222221','11122111')
ITEM_ARM_FRONT = (
    '1221','2332','3442','6776','.55.','5..5',
    '5665','6776','1221','....','....','....',
)
ITEM_ARM_BACK = (
    '1221','2332','2332','6776','.55.','5..5',
    '5665','6776','1221','....','....','....',
)
ITEM_ARM_SIDE = (
    '1121','1231','2331','6776','5555','5..5',
    '5665','6776','1221','....','....','....',
)
...
def armor_texture(tier, inner=False):
    ...
    # The shaft begins halfway down the leg UV. Its invisible upper section
    # must not leave an opaque top cap floating above the finished boot.
    image.paste((0,0,0,0),(4,16,8,20))
