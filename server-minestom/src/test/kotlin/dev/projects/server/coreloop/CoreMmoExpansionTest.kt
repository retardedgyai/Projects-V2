...
internal fun coreExpansionRow(row: String) = row.substringBefore('\t') in setOf("survey", "profession", "buy-order", "dungeon-record", "gear-quality", "dungeon-run", "journey", "gear-base", "map-level", "class-build")
